...
heroPlayer.setAttribute(
  "src",
  "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/255766399&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"
);

// special header layout for desktop
let heroContainerDesktop = elementCreator(
  "div",
  "hero__desktop-container",
  hero
);

let heroContainerHeaderWrapper = elementCreator(
  "div",
  "hero__desktop-wrapper",
  heroContainerDesktop
);

let heroTitleDesktop = elementCreator(
  "h3",
  "hero__title hero__title--desktop",
  heroContainerHeaderWrapper
);
heroTitleDesktop.innerText = "Beautiful Beasts Album";

let heroHeaderTopDesktop = elementCreator(
  "h1",
  "hero__header hero__header--desktop",
  heroContainerHeaderWrapper
);
heroHeaderTopDesktop.innerText = "Queen of Yellow";

let heroHeaderBottomDesktop = elementCreator(
  "h1",
  "hero__header hero__header--desktop",
  heroContainerHeaderWrapper
);
...
let heroPlayerDesktop = elementCreator(
  "iframe",
  "hero__player hero__player--desktop",
  heroContainerDesktop
);
heroPlayerDesktop.setAttribute(
  "src",
  "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/255766399&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"
);
...
let showsHeadersCard = elementCreator(
  "div",
  "shows__header-container shows__header-container--hidden shows__header-container--divider",
  showsWrapper
);

let showsHeadersDateItem = elementCreator(
  "div",
  "shows__item shows__item--desktop-padding",
  showsHeadersCard
);

let showsHeadersDateHeader = elementCreator(
  "div",
  "shows__header",
  showsHeadersDateItem
);
showsHeadersDateHeader.innerText = "Date";

let showsHeadersVenueItem = elementCreator(
  "div",
  "shows__item",
  showsHeadersCard
);

let showsHeadersVenueHeader = elementCreator(
  "div",
  "shows__header",
  showsHeadersVenueItem
);
showsHeadersVenueHeader.innerText = "Venue";

let showsHeadersLocationItem = elementCreator(
  "div",
  "shows__item",
  showsHeadersCard
);

let showsHeadersLocationHeader = elementCreator(
  "div",
  "shows__header",
  showsHeadersLocationItem
);
...
const populateDates = (showsList) => {
  showsList.forEach((show, index) => {
    ...
    // create Date
    let showDateItem = elementCreator(
      "div",
      "shows__item shows__item--desktop-padding",
      showCard
    );
    ...
    let showDateText = elementCreator(
      "p",
      "shows__text shows__text--date",
      showDateItem
    );
    ...
    let showLocationHeader = elementCreator(
      "h5",
      "shows__header",
      showLocationItem
    );
    ...
    // create Button
    let showButtonItem = elementCreator(
      "div",
      "shows__item shows__item--button-end",
      showCard
    );
